    ...
    <div>
      {result && (
        ...
        >
          ...
          <div className="flex items-center justify-end gap-5 bg-gray-50 py-3 px-6">
            {!(isEditing || isDeleting) && (
              <>
                <button
                  type="button"
                  disabled={isDeleting}
                  className="rounded-md border border-transparent bg-red-800 py-2 px-4 text-sm font-medium text-white shadow-sm hover:bg-red-900 focus:outline-none focus:ring-2 focus:ring-red-900 focus:ring-offset-2"
